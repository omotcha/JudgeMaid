prompt_entity_recognition_zh = """
    下面文字介绍了某公司及其产品，请根据要求从中提取关键信息，并用{display_format}的形式来描述。
...
prompt_entity_recognition_en = """
    Following is an introduction to a company and its products, please extract detailed information in {display_format} format as requested.
